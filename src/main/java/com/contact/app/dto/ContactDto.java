...
public class ContactDto {
    ...
    public ContactDto(Long id, String nom, String prenom, String email, String telephone, String adresse, Long groupeId, String groupeNom) {
        this.id = id; this.nom = nom; this.prenom = prenom; this.email = email;
        this.telephone = telephone; this.adresse = adresse; this.groupeId = groupeId; this.groupeNom = groupeNom;
    }
